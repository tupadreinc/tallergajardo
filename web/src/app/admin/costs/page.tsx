        ...
        <div className="relative z-10 bg-success/10 border border-success/20 py-4 px-8 rounded-2xl flex-shrink-0 w-full md:w-auto text-center flex flex-col">
          ...
          {sortedMonthlyCosts.length > 0 && (
            <div className="mt-4 flex flex-col gap-1 border-t border-success/20 pt-3">
              ...
              <div className="mt-3 pt-3 flex flex-col gap-1 border-t border-success/20">
                <div className="flex items-center justify-between gap-6 text-sm">
                  <span className="font-medium text-success/90 text-left">Total Pagado</span>
                  <span className="font-bold text-success">{clpFormatter.format(totalPaid)}</span>
                </div>
                <div className="flex items-center justify-between gap-6 text-sm">
                  <span className="font-medium text-amber-600/90 text-left">Total por Pagar</span>
                  <span className="font-bold text-amber-600">{clpFormatter.format(totalPending)}</span>
                </div>
              </div>
            </div>
          )}
